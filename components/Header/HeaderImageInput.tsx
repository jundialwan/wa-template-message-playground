...
const HeaderImageInput: FC = () => {
  ...
  const DummyImage =
    'https://images.unsplash.com/photo-1635924210685-d1e81cad5fb8?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1471&q=80';
    ...
    <div className='mt-2 flex flex-col items-start'>
      ...
      <label className='block'>
        <input
          ...
          onChange={(e) => setHeaderPathImage(e.target.value)}
          value={headerPathImage}
        />
      </label>
    </div>
  );
