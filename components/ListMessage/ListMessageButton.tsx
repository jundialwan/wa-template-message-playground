...
const ListMessageButton: FC = () => {
  ...
  return (
    <>
      ...
      <Transition appear show={isShowMessage && isOpened} className='bg-black bg-opacity-40 top-0 left-0 right-0 bottom-0 absolute z-10'></Transition>
      <Transition appear show={isShowMessage && isOpened} className='absolute top-[64%] left-0 right-0 '>
