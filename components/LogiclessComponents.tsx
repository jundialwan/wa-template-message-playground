    ...
    <PreviewComponentContainer className='relative flex-auto border-solid border-1 shadow-sm rounded-sm bg-[#e5ddd5] '>
      <div className='flex flex-col overflow-y-auto h-full'>
        <div className='flex flex-col relative'>
          <Transition appear show={isOpened} className='bg-black bg-opacity-40 top-0 left-0 right-0 bottom-0 absolute z-10'></Transition>
        ...
        <div className='h-full overflow-y-auto relative max-h-[900px]'>
