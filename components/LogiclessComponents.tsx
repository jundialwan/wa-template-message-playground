...
export const SectionSubtitle: FC<{ subtitle: string }> = ({ subtitle }) => (
      ...
      <div className='flex flex-col'>
        <div className='w-full flex justify-end items-center bg-whatsapp-500 py-1 px-2 space-x-1'>
          ...
          >
            <path
              fillRule='evenodd'
              clipRule='evenodd'
              d='M0.977371 4.01593C3.48822 2.12256 6.61301 1 10 1C13.387 1 16.5118 2.12256 19.0226 4.01593L10 15L0.977371 4.01593Z'
              fill='white'
            />
          </svg>
          ...
          >
            <path
              fillRule='evenodd'
              clipRule='evenodd'
              d='M9 1.875V1L6 1V1.875H3V15H12V1.875H9Z'
              fill='white'
            />
          </svg>
        ...
        <div className='w-full flex items-center bg-whatsapp-600 pt-2 pb-3 px-2'>
          <div className='flex w-auto items-center'>
            ...
            <img
              src='/logo-brand/panorama.png'
              className='h-9 w-9 mr-3'
              alt='Panorama'
            />
            <h6 className='font-bold text-white capitalize mr-2 text-lg'>
              Panorama
            </h6>
            <img
              src='/ornament/whatsapp-checklist.png'
              className='h-4 w-4'
              alt=''
            />
          </div>
        ...
        <div className='flex w-full'>
          <label
            htmlFor=''
            className='my-3 mx-auto bg-ocean-100 shadow-day-bubble px-3  py-2 text-gray-600 uppercase font-semibold rounded-md'
          >
            Today
          </label>
        </div>
