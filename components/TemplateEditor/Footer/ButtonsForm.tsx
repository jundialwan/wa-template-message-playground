...
const ButtonsForm: FC<{ buttonType: string; onButtonTypeChange: ChangeEventHandler<HTMLInputElement>; buttonCta: string[]; buttonReply: string[] }> = ({ buttonType, onButtonTypeChange, buttonCta, buttonReply }) => {
    ...
    <div className='flex flex-row items-center gap-1 mt-2'>
      <div className='gap-1'>
        ...
        <div className='flex flex-row gap-1 items-center border px-3 py-2 rounded-lg'>
          <Switch isChecked={thisButton.enabled} size='sm' colorScheme='teal' ringColor='#047857' onChange={onToggleChange} />
