...
const FooterForm: FC<{ footerText: string; messageId: number; onFooterTextChange: ChangeEventHandler<HTMLInputElement> }> = ({ footerText, messageId, onFooterTextChange }) => {
  ...
  return (
    <>
      <input type='text' name='footer' id='footer' value={footerText} onChange={onFooterTextChange} tw='w-full border py-1 px-2 rounded text-black text-sm focus:outline-none focus:ring-2 focus:ring-green-100 focus:border-green-600' />
